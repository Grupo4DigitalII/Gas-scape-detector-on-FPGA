...
from module import drivermotor
...
class BaseSoC(SoCCore):
	def __init__(self):
		...
		platform.add_source("module/verilog/driverMotor.v")
...
#			cpu_type="vexriscv",
		...
		#driver Motores
		SoCCore.add_csr(self, "driverM")
		driverM_inputs = Cat(*[platform.request("dm", i) for i in range(2)])
		driverM_outputs = Cat(*[platform.request("dm", i) for i in range(2,4)])
		self.submodules.driverM = drivermotor.DriverMotor(driverM_inputs, driverM_outputs)
